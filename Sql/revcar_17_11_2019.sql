...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Nov-2019 às 22:55
...
CREATE TABLE `carro` (
  ...
  `km_utima_revisao` int(7) NOT NULL
...
INSERT INTO `carro` (`id`, `placa`, `marca`, `modelo`, `ano`, `dt_ultima_revisao`, `km_utima_revisao`) VALUES
(7, 'ABK-3500', 'Chevrolet', 'Astra hacht', 2000, '2019-10-17', 2),
(9, 'TRE-1313', 'Chevrolet', 'ChevetÃ£o', 1997, '2019-12-25', 0),
(11, 'ERT-1313', 'Chevrolet', 'ChevetÃ£o', 2000, '2019-11-17', 100);
...
(11, 'Motorista 20', 'teste@teste', 2, '2019-10-01', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 9, 0),
(12, 'Motorista 2', 'teste@teste2', 2, '2019-05-24', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 11, 1);
...
(2, '2019-10-22', 37, 7),
(3, '2019-10-29', 123, 7),
(4, '2019-10-29', 231231, 7),
(5, '2019-10-29', 4355, 7),
(6, '2019-11-17', 10000000, 11);
