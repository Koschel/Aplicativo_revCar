...
<div >
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input name="placa" type="text" class="form-control" id="inputText3"  value="<?php echo $dado['placa']?>" placeholder="<?php echo $dado['placa']?>" onkeypress="$(this).mask('AAA-0A00');">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
    <div class="col-sm-10">
      <button type="submit" value ="<?php echo $dado["id"]?>" name="id_car" class="btn btn-dark">Cadastrar</button>
    </div>       
</form>
